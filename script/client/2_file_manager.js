...
class FileManager {
    ...
    async upload(file, params, checkName, allowStream = true) {
        ...
        __classPrivateFieldGet(this, _FileManager_Lupload, "f").debug("uploading " + whatIsUploaded + " with chunk size of " + chunkSize + " and pool size of " + _0_utilities_js_1.UPLOAD_POOL_SIZE + " and file ID of " + fileId);
        let result;
    ...
    async *downloadInner(location, dcId, params) {
        ...
        while (true) {
            for (let i = 0; i < _0_utilities_js_1.DOWNLOAD_POOL_SIZE; ++i) {
                for (let i = 0; i < _0_utilities_js_1.DOWNLOAD_REQUEST_PER_CONNECTION; ++i) {
