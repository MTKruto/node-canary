...
async function encryptMessage(message, authKey, authKeyId, salt, sessionId) {
    ...
    const a = await (0, _1_utilities_js_1.sha256)((0, _0_deps_js_1.concat)([messageKey, authKey.subarray(0, 36)]));
    const b = await (0, _1_utilities_js_1.sha256)((0, _0_deps_js_1.concat)([authKey.subarray(40, 76), messageKey]));
...
async function decryptMessage(buffer, authKey, authKeyId, _sessionId) {
    ...
    const a = await (0, _1_utilities_js_1.sha256)((0, _0_deps_js_1.concat)([messageKey, authKey.subarray(8, 44)]));
    const b = await (0, _1_utilities_js_1.sha256)((0, _0_deps_js_1.concat)([authKey.subarray(48, 84), messageKey]));
    const aesKey = (0, _0_deps_js_1.concat)([a.subarray(0, 8), b.subarray(8, 24), a.subarray(24, 32)]);
    const aesIv = (0, _0_deps_js_1.concat)([b.subarray(0, 8), a.subarray(8, 24), b.subarray(24, 32)]);
